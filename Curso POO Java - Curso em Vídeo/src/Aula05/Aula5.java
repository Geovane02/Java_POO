...
public class Aula5 {
	...
	public static void main(String[] args) {
		...
		ContaBanco terceiroCadastro;
		terceiroCadastro = new ContaBanco();
		
		terceiroCadastro.abrirConta("Conta Poupança");
		terceiroCadastro.setTipoConta("Conta Poupança");
		terceiroCadastro.setDonoConta("Jorubeba");
		terceiroCadastro.setNumeroConta(876543219);
		//terceiroCadastro.sacarValor(150);
		
		terceiroCadastro.pagarMensalidade();
		
		terceiroCadastro.estadoAtual();
